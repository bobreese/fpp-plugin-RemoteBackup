...
for f in run_backup.sh dry_run.sh probe_storage.sh probe_remotes.sh ssh_setup.sh mount_usb.sh format_usb.sh list_backups.sh get_backup_info.sh delete_backup.sh lib_common.sh; do
